;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="d6108d6e-a3fa-2e18-dc7f-a55fa288c985")}catch(e){}}();
module.exports = [
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/getBuildPluginOptions.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/handleRunAfterProductionCompile.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const getBuildPluginOptions = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/getBuildPluginOptions.js [instrumentation] (ecmascript)");
/**
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/manifest/createRouteManifest.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/util.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const core = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/core/build/cjs/index.js [instrumentation] (ecmascript)");
const fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
const resolve = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/node_modules/resolve/index.js [instrumentation] (ecmascript)");
/**
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/turbopack/generateValueInjectionRules.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
    ...
    if (Object.keys(clientValues).length > 0) {
        rules.push({
            ...
            rule: {
                loaders: [
                    {
                        loader: path.resolve(("TURBOPACK compile-time value", "/ROOT/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/turbopack"), '..', 'loaders', 'valueInjectionLoader.js'),
                        options: {
                            values: clientValues
                        }
                    }
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/turbopack/constructTurbopackConfig.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const core = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/core/build/cjs/index.js [instrumentation] (ecmascript)");
const util = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/util.js [instrumentation] (ecmascript)");
const generateValueInjectionRules = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/turbopack/generateValueInjectionRules.js [instrumentation] (ecmascript)");
/**
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/webpack.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
    ...
    return function newWebpackFunction(incomingConfig, buildContext) {
        ...
        if (isServer && userSentryOptions.webpack?.autoInstrumentServerFunctions !== false) {
            ...
            newConfig.module.rules.unshift({
                ...
                use: [
                    {
                        loader: path.resolve(("TURBOPACK compile-time value", "/ROOT/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config"), 'loaders', 'wrappingLoader.js'),
                        options: {
...
function addValueInjectionLoader({ newConfig, userNextConfig, userSentryOptions, buildContext, releaseName, routeManifest, nextJsVersion }) {
    ...
    if (buildContext.isServer) {
        newConfig.module.rules.push({
            ...
            use: [
                {
                    loader: path.resolve(("TURBOPACK compile-time value", "/ROOT/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config"), 'loaders/valueInjectionLoader.js'),
                    options: {
                        values: serverValues
                    }
                }
...
function addEdgeRuntimePolyfills(newConfig, buildContext) {
    ...
    newConfig.plugins.push(new buildContext.webpack.ProvidePlugin({
        performance: [
            path.resolve(("TURBOPACK compile-time value", "/ROOT/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config"), 'polyfills', 'perf_hooks.js'),
            'performance'
        ]
    }));
    ...
    newConfig.resolve.alias = {
        ...
        perf_hooks: path.resolve(("TURBOPACK compile-time value", "/ROOT/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config"), 'polyfills', 'perf_hooks.js')
    };
}
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const core = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/core/build/cjs/index.js [instrumentation] (ecmascript)");
const node = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/node/build/cjs/index.js [instrumentation] (ecmascript)");
const childProcess = __turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)");
const fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
const path = __turbopack_context__.r("[externals]/path [external] (path, cjs)");
const handleRunAfterProductionCompile = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/handleRunAfterProductionCompile.js [instrumentation] (ecmascript)");
const createRouteManifest = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/manifest/createRouteManifest.js [instrumentation] (ecmascript)");
const constructTurbopackConfig = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/turbopack/constructTurbopackConfig.js [instrumentation] (ecmascript)");
const util = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/util.js [instrumentation] (ecmascript)");
const webpack = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/webpack.js [instrumentation] (ecmascript)");
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/debug-build.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/devErrorSymbolicationEventProcessor.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const core = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/core/build/cjs/index.js [instrumentation] (ecmascript)");
const stackTraceParser = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/stacktrace-parser/dist/stack-trace-parser.esm.js [instrumentation] (ecmascript)");
const debugBuild = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/debug-build.js [instrumentation] (ecmascript)");
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/getVercelEnv.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/nextSpanAttributes.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const constants = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/next/constants.js [instrumentation] (ecmascript)");
/**
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/urls.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/setUrlProcessingMetadata.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const core = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/core/build/cjs/index.js [instrumentation] (ecmascript)");
const urls = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/urls.js [instrumentation] (ecmascript)");
/**
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/server/distDirRewriteFramesIntegration.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/addHeadersAsAttributes.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/dropMiddlewareTunnelRequests.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const nextSpanAttributes = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/nextSpanAttributes.js [instrumentation] (ecmascript)");
const spanAttributesWithLogicAttached = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [instrumentation] (ecmascript)");
const globalWithInjectedValues = core.GLOBAL_OBJ;
/**
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/tracingUtils.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/server/handleOnSpanStart.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const opentelemetry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/opentelemetry/build/cjs/index.js [instrumentation] (ecmascript)");
const nextSpanAttributes = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/nextSpanAttributes.js [instrumentation] (ecmascript)");
const addHeadersAsAttributes = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/addHeadersAsAttributes.js [instrumentation] (ecmascript)");
const dropMiddlewareTunnelRequests = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/dropMiddlewareTunnelRequests.js [instrumentation] (ecmascript)");
const tracingUtils = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/tracingUtils.js [instrumentation] (ecmascript)");
/**
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/responseEnd.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/_error.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const core = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/core/build/cjs/index.js [instrumentation] (ecmascript)");
const responseEnd = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/responseEnd.js [instrumentation] (ecmascript)");
/**
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/isUseCacheFunction.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/nextSpan.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const core = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/core/build/cjs/index.js [instrumentation] (ecmascript)");
const debugBuild = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/debug-build.js [instrumentation] (ecmascript)");
const isBuild = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [instrumentation] (ecmascript)");
const isUseCacheFunction = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/isUseCacheFunction.js [instrumentation] (ecmascript)");
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/wrapperUtils.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetStaticPropsWithSentry.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const isBuild = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [instrumentation] (ecmascript)");
const wrapperUtils = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/wrapperUtils.js [instrumentation] (ecmascript)");
/**
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetInitialPropsWithSentry.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapAppGetInitialPropsWithSentry.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapDocumentGetInitialPropsWithSentry.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapErrorGetInitialPropsWithSentry.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetServerSidePropsWithSentry.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/nextNavigationErrorUtils.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/wrapServerComponentWithSentry.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const core = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/core/build/cjs/index.js [instrumentation] (ecmascript)");
const nextNavigationErrorUtils = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/nextNavigationErrorUtils.js [instrumentation] (ecmascript)");
const responseEnd = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/responseEnd.js [instrumentation] (ecmascript)");
/**
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/wrapRouteHandlerWithSentry.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentryVercelCrons.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/wrapMiddlewareWithSentry.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapPageComponentWithSentry.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/wrapGenerationFunctionWithSentry.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/withServerActionInstrumentation.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/captureRequestError.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentry.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/server/index.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const node = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/node/build/cjs/index.js [instrumentation] (ecmascript)");
const debugBuild = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/debug-build.js [instrumentation] (ecmascript)");
const devErrorSymbolicationEventProcessor = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/devErrorSymbolicationEventProcessor.js [instrumentation] (ecmascript)");
const getVercelEnv = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/getVercelEnv.js [instrumentation] (ecmascript)");
const nextSpanAttributes = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/nextSpanAttributes.js [instrumentation] (ecmascript)");
const spanAttributesWithLogicAttached = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [instrumentation] (ecmascript)");
const isBuild = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [instrumentation] (ecmascript)");
const setUrlProcessingMetadata = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/setUrlProcessingMetadata.js [instrumentation] (ecmascript)");
const distDirRewriteFramesIntegration = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/server/distDirRewriteFramesIntegration.js [instrumentation] (ecmascript)");
const handleOnSpanStart = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/server/handleOnSpanStart.js [instrumentation] (ecmascript)");
const _error = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/_error.js [instrumentation] (ecmascript)");
const nextSpan = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/nextSpan.js [instrumentation] (ecmascript)");
const wrapGetStaticPropsWithSentry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetStaticPropsWithSentry.js [instrumentation] (ecmascript)");
const wrapGetInitialPropsWithSentry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetInitialPropsWithSentry.js [instrumentation] (ecmascript)");
const wrapAppGetInitialPropsWithSentry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapAppGetInitialPropsWithSentry.js [instrumentation] (ecmascript)");
const wrapDocumentGetInitialPropsWithSentry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapDocumentGetInitialPropsWithSentry.js [instrumentation] (ecmascript)");
const wrapErrorGetInitialPropsWithSentry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapErrorGetInitialPropsWithSentry.js [instrumentation] (ecmascript)");
const wrapGetServerSidePropsWithSentry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetServerSidePropsWithSentry.js [instrumentation] (ecmascript)");
const wrapServerComponentWithSentry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/wrapServerComponentWithSentry.js [instrumentation] (ecmascript)");
const wrapRouteHandlerWithSentry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/wrapRouteHandlerWithSentry.js [instrumentation] (ecmascript)");
const wrapApiHandlerWithSentryVercelCrons = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentryVercelCrons.js [instrumentation] (ecmascript)");
const wrapMiddlewareWithSentry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/wrapMiddlewareWithSentry.js [instrumentation] (ecmascript)");
const wrapPageComponentWithSentry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapPageComponentWithSentry.js [instrumentation] (ecmascript)");
const wrapGenerationFunctionWithSentry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/wrapGenerationFunctionWithSentry.js [instrumentation] (ecmascript)");
const withServerActionInstrumentation = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/withServerActionInstrumentation.js [instrumentation] (ecmascript)");
const captureRequestError = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/captureRequestError.js [instrumentation] (ecmascript)");
const wrapApiHandlerWithSentry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentry.js [instrumentation] (ecmascript)");
...
"[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/index.server.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const withSentryConfig = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig.js [instrumentation] (ecmascript)");
const index = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/server/index.js [instrumentation] (ecmascript)");
const _error = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/_error.js [instrumentation] (ecmascript)");
const nextSpan = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/utils/nextSpan.js [instrumentation] (ecmascript)");
const wrapApiHandlerWithSentry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentry.js [instrumentation] (ecmascript)");
const wrapGetStaticPropsWithSentry = __turbopack_context__.r("[project]/CLAUDE/projects/1. Loop Desk/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetStaticPropsWithSentry.js [instrumentation] (ecmascript)");
...
//# debugId=d6108d6e-a3fa-2e18-dc7f-a55fa288c985
//# sourceMappingURL=39e33_%40sentry_nextjs_build_cjs_bce0b0e2._.js.map