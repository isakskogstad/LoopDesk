        ...
        try {
          await prisma.watchedCompany.upsert({
            ...
            update: {
              ...
              revenue: company.revenue != null ? BigInt(company.revenue) : null,
              profit: company.profit != null ? BigInt(company.profit) : null,
              equityRatio: company.equityRatio ?? null,
              status: company.status ?? null,
              valuation: company.valuation != null ? BigInt(company.valuation) : null,
